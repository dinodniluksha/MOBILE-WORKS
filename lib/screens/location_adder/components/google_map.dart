...
class CustomGoogleMap extends StatefulWidget {
  ...
  static Map<String, dynamic> data = {
    "pickedPoint": LatLng(initLatitude, initLongitude),
    "pickedAddress": ''
  };
...
class _CustomGoogleMapState extends State<CustomGoogleMap> {
  var initPoint = LatLng(initLatitude, initLongitude);
  late CameraPosition _cameraPosition;
  late GoogleMapController _controller;

  @override
  void initState() {
    _cameraPosition = CameraPosition(target: initPoint, zoom: initZoomOne);
    getCurrentLocation();
    super.initState();
  }
  ...
  getLocation() async {
    ...
    setState(() {
      ...
      _cameraPosition = CameraPosition(target: initPoint, zoom: initZoomTwo);
